...
| 49      | [cursor-dev-49-mnemospark-client-storage-ls-list-friendly-names.md](cursor-dev-49-mnemospark-client-storage-ls-list-friendly-names.md) | Client: wallet-only `ls`, list, SQLite names + cron + payment columns, `ls -l` layout, human sizes (depends on 48) |
