...
| 49      | [cursor-dev-49-mnemospark-client-storage-ls-list-friendly-names.md](cursor-dev-49-mnemospark-client-storage-ls-list-friendly-names.md) | Client: wallet-only `ls`, list response, SQLite names, `ls -l`-style columns, human-readable sizes (depends on 48) |
