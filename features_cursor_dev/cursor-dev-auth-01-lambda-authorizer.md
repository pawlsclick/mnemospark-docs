...
- **Acceptance criteria (checkboxes):**
  ...
  - [ ] Request path normalized (stage stripped) before signature verification; verifyingContract from auth spec §2.3.
