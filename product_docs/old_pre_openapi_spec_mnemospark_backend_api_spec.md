...
| (payment)      | —      | Yes               | **Outstanding:** EIP-712 payment authorization — placement (header vs body) and exact shape TBD. See [wallet_gen_payment_eip712.md](./wallet_gen_payment_eip712.md).                                                                                                                                                                   |
...
- [wallet_gen_payment_eip712.md](./wallet_gen_payment_eip712.md) — EIP-712 payment example.
