...
Align **descriptions and metadata** with [mnemospark_PRD.md](../product_docs/mnemospark_PRD.md). mnemospark is an OpenClaw plugin for **storage + wallet + x402 payment**; it does **not** provide chat or "Smart LLM router."
...
- [mnemospark_PRD.md](../product_docs/mnemospark_PRD.md) — product description, R8 (plugin, /wallet, /cloud).
