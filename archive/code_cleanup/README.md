...
Right-sized execution plan for **Cursor Cloud Agents** to prune the mnemospark repo to workflow-only behavior. mnemospark does **not** provide chat; it provides **storage + wallet + x402 payment** per [mnemospark_full_workflow.md](../product_docs/mnemospark_full_workflow.md) and [mnemospark_PRD.md](../product_docs/mnemospark_PRD.md).

**Product context:** [mnemospark_PRD.md](../product_docs/mnemospark_PRD.md), [mnemospark_full_workflow.md](../product_docs/mnemospark_full_workflow.md). Design pattern: [features_cursor_dev/README.md](../features_cursor_dev/README.md).
